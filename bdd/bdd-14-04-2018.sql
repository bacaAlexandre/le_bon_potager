...
CREATE TABLE IF NOT EXISTS `le_bon_potager`.`T_UTILISATEURS` (
  ...
  `utiRole_id` INT NOT NULL DEFAULT 100,
...
CREATE TABLE IF NOT EXISTS `le_bon_potager`.`T_PRODUITS` (
  ...
  PRIMARY KEY (`id_produit`, `proCategorie_id`),
...
CREATE TABLE IF NOT EXISTS `le_bon_potager`.`T_PRODUITS_UTILISATEURS` (
  ...
  `puUnite_id` INT NOT NULL,
  `puDesative` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_produit_utilisateur`, `puVendeur_id`, `puProduit_id`, `puUnite_id`),
  ...
  INDEX `fk_T_PRODUITS_UTILISATEURS_T_UNITE1_idx` (`puUnite_id` ASC),
  ...
  CONSTRAINT `fk_T_UTILISATEURS_has_T_PRODUITS_T_PRODUITS1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_T_PRODUITS_UTILISATEURS_T_UNITE1`
    FOREIGN KEY (`puUnite_id`)
...
CREATE TABLE IF NOT EXISTS `le_bon_potager`.`T_LOGIN` (
  ...
  `T_UTILISATEURS_id_utilisateur` INT NOT NULL,
  `T_UTILISATEURS_utiRole_id` INT NOT NULL,
  `T_UTILISATEURS_utiCp_id` INT NOT NULL,
  PRIMARY KEY (`logSelector`, `T_UTILISATEURS_id_utilisateur`, `T_UTILISATEURS_utiRole_id`, `T_UTILISATEURS_utiCp_id`),
  INDEX `fk_T_LOGIN_T_UTILISATEURS1_idx` (`T_UTILISATEURS_id_utilisateur` ASC, `T_UTILISATEURS_utiRole_id` ASC, `T_UTILISATEURS_utiCp_id` ASC),
  CONSTRAINT `fk_T_LOGIN_T_UTILISATEURS1`
    FOREIGN KEY (`T_UTILISATEURS_id_utilisateur` , `T_UTILISATEURS_utiRole_id` , `T_UTILISATEURS_utiCp_id`)
    REFERENCES `le_bon_potager`.`T_UTILISATEURS` (`id_utilisateur` , `utiRole_id` , `utiCp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
