...
<html lang="fr">
    <head>
        ...
        <script type="text/javascript" src="<?php echo ASSET_URL; ?>lib/momentjs/js/momentjs.js"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.js"></script>
        <script type="text/javascript" src='https://api.tiles.mapbox.com/mapbox-gl-js/v0.45.0/mapbox-gl.js'></script>
        ...
        <script type="text/javascript" src="https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-language/v0.9.2/mapbox-gl-language.js"></script>
        ...
        <script type="text/javascript" src="<?php echo ASSET_URL; ?>js/inscription.js"></script>
        <script type="text/javascript" src="<?php echo ASSET_URL; ?>js/connexion.js"></script>
    </head>
    ...
    <body>
        <div class="container">
            <header>
                ...
                <?php } else { ?>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#connexion">Connectez-vous</button>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#inscription">Inscrivez-vous</button>
