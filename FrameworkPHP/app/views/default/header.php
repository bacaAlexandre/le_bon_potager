...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ASSET_URL; ?>lib/jquery-ui/css/jquery-ui.css" type="text/css">
    <link rel="icon" type="image/x-icon" href="<?php echo ASSET_URL; ?>favicon.ico"/>
    <!-- JavaScript -->
    ...
    <title><?php echo TITLE; ?></title>
        ...
        <script type="text/javascript" src="<?php echo ASSET_URL; ?>js/connexionInscription.js"></script>
    </head>
    ...
    <body>
        <div class="container">
            <header>
                ...
                <?php } else { ?>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#connection">Connectez-vous</button>
