$(function() {
    ...
    $(form).on('submit', function(e) {
        ...
        $.ajax({
            url: 'https://api-adresse.data.gouv.fr/search/?q=' + (adresse.val().length > 0 ? adresse.length : undefined) + '&postcode=' + $(code_postal).find(':selected').data('code-postal') + '&autocomplete=0&limit=1',
            method: 'GET',
