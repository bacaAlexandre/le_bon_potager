...
INSERT INTO `T_UTILISATEURS` (`id_utilisateur`, `utiPseudo`, `utiEmail`, `utiMdp`, `utiAdresse`, `utiRole_id`, `utiCp_id`)
VALUES
...
INSERT INTO `T_PRODUITS_UTILISATEURS` (`id_produit_utilisateur`, `puVendeur_id`, `puProduit_id`, `puCommentaire`, `puQuantite`, `puUnite_id`, `puDesactive`)
VALUES
  (1, 2, 1, NULL, 5, 1, 0),
  (2, 2, 2, NULL, 3, 1, 1),
